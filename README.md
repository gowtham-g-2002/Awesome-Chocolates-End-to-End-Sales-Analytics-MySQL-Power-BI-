...
The dashboard provides a consolidated view of sales performance across time, geography, products, and sales teams, enabling stakeholders to monitor trends and identify improvement areas.

Key Dashboard Components:

Total Sales, Total Boxes, Shipment Count & LBS%
...
Product Category-wise analysis (Bars, Bites, Other)
...
sales – Transaction-level sales data (amount, boxes, customers, shipment count, sale date)

geo – Country and region mapping

people – Salesperson details, teams, and locations

products – Product details, category, size, and cost per box
...
Identify top & low-performing regions and geographies
...
Geography-wise sales comparison
...
DAX measures (Total Sales, Total Boxes, LBS%)
...
Identifying peak and low sales periods

Recognizing high-performing salespersons and regions

Detecting inefficient shipments through LBS%

Understanding category-wise sales contribution
